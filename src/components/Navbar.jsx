...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`md:w-3/4 mx-auto p-4 md:p-6 pt-15 transition-all duration-300 ${isOpen ? 'mr-50' : ''}`}>
          ...
          <div>
            ...
            >
              ...
              <motion.li
                ...
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }} data-value={'theme-light'} className="bg-imranbglight-500 text-white border border-red-900 px-4 py-2 rounded-full w-8 h-8 shadow-lg text-sm"></motion.li>
              <motion.li
                variants={{
                  hidden: { opacity: 0, scale: 0.8 },
                  visible: { opacity: 1, scale: 1 },
                ...
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }} data-value={'theme-purple'} className="bg-imranbgpurple-500 text-white border px-4 py-2 rounded-full w-8 h-8 shadow-lg text-sm"></motion.li>
            </ul>
            
            {/* nav links */}
            <div className="mt-6 border-t py-5 md:hidden">
